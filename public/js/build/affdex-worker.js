...
function ctor(url) {
  try {
    ...
    this.importScripts(URL + "affdex-native-bindings.asm.js")  // changed reference 4 March 2020 by Valentin
    this.importScripts(URL + "affdex-native-bindings.js")      // changed reference 4 March 2020 by Valentin
